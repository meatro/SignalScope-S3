    ...
    function initLeftSidebar() {
        ...
        if ($(".side-nav").length) {
            ...
            navToggle.on('click', function (e) {
                ...
                var $trigger = $(this);
                var target = $trigger.attr('data-bs-target') || $trigger.attr('href');
            ...
            $(".side-nav a").each(function () {
                ...
                if (this.href == pageUrl) {
                    var $link = $(this);
                    var isDirectTopLevelLink = $link.parent().parent().hasClass('side-nav');
                    var $parentCollapse = $link.closest('.collapse');

                    if (isDirectTopLevelLink) {
                        var $topLevelItem = $link.closest('.side-nav-item');
                        $link.addClass("active");
                        $topLevelItem.addClass("menuitem-active nav-current");
                    } else if ($parentCollapse.length) {
                        $parentCollapse.addClass("show");
                        $parentCollapse.closest('.side-nav-item').addClass("menuitem-active nav-current");
                    }
                }
            });
            ...
            setTimeout(function () {
                var activatedItem = document.querySelector('li.menuitem-active > .side-nav-link, li.menuitem-active .active');
